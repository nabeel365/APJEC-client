        ...
        <div>
            ...
            <div className="carousel w-full max-h-[600px] relative">
                ...
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="/src/images/apjec1.jpg" alt="Education" className="w-full h-full object-cover" />
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <img src="/src/images/apjec2.jpg" alt="Law College" className="w-full h-full object-cover" />
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <img src="/src/images/apjec3.jpg" alt="Classroom" className="w-full h-full object-cover" />
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <img src="/src/images/apjec4.jpg" alt="Classroom" className="w-full h-full object-cover" />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#BADFE7] via-transparent to-transparent"></div>
                    <div className="absolute bottom-10 left-10 text-[#2b6777] space-y-4">
                        <h1 className="text-3xl md:text-5xl font-bold">Interactive Sessions & Workshops</h1>
                        <p className="text-lg md:text-xl">Learn through hands-on activities and expert guidance.</p>
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    <img src="/src/images/apjec5.jpg" alt="Success" className="w-full h-full object-cover" />
