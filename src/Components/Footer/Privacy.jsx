...
const PrivacyPolicy = () => (
  <div className="p-10 bg-[#BADFE7] text-[#2b6777]">
    ...
    <p className="mt-4">At APJ Abdul Kalam Education Centre, we value your privacy. This document outlines how we collect, use, and protect your data.</p>
    ...
    <p>For queries, contact <a href="mailto:apjec.education@gmail.com" className="text-[#388087]">apjec.education@gmail.com</a></p>
  </div>
);
