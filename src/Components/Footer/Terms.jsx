...
const TermsAndConditions = () => {
  ...
  return (
    <div className="p-10 bg-[#F6F6F2] text-[#2b6777]">
      ...
      <p className="mt-4">
        These Terms & Conditions (Terms) govern the use of our website: 
        <a href="https://www.apjec.org" className="text-[#388087]"> www.apjec.org</a> and any associated services.
      </p>
